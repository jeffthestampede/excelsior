...
$CFG->dbtype    = 'mariadb';      // 'mariadb', 'mariadb', 'mysqli', 'mssql', 'sqlsrv' or 'oci'
$CFG->dblibrary = 'native';     // 'native' only at the moment
$CFG->dbhost    = 'localhost';  // eg 'localhost' or 'db.isp.com' or IP
$CFG->dbname    = 'excelsior89_moo1';     // database name, eg moodle
$CFG->dbuser    = 'excelsior89_moo1';   // your database username
$CFG->dbpass    = 'R^WjMY7RGGVsa@MLHk*66*]1';   // your database password
$CFG->prefix    = 'mood_';       // prefix to use for all table names
$CFG->dboptions = array(
...
$CFG->wwwroot   = 'http://www.excelsiorschool.com/moodle';
...
$CFG->dataroot  = '/var/www/vhosts/excelsiorschool.com/httpdocs/moodle/data';
...
//           'dbhost' => 'localhost',
//           'dbname' => 'moodletest',
//           'dbuser' => 'excelsior89_moo1',
//           'dbpass' => 'excelsior89_moo1',
//           'behat_prefix' => 'mood_',

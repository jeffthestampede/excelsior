...
$LANG["phrase_add_field_sp"] = "Add Field(s)";
...
$LANG["phrase_edit_submission_page_label"] = "Edit Submission Page Label";
...
$LANG["notify_no_assigned_field_option_group"] = "This field has not been assigned to a field option group.";
...
$LANG["validation_password_too_short"] = "Your password needs to be at least <b>{\$number}</b> characters long.";
$LANG["validation_client_password_missing_uppercase"] = "The client password must contain at least one uppercase letter.";
$LANG["validation_password_missing_uppercase"] = "Your password must contain at least one uppercase letter.";
$LANG["validation_client_password_missing_number"] = "The client password must contain at least one number (0-9).";
$LANG["validation_password_missing_number"] = "Your password must contain at least one number (0-9).";
...
$LANG["validation_password_missing_special_char"] = "Your password must contain at least one of the following characters: <b>{\$chars}</b>";

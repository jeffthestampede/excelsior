<?php /* Smarty version 2.6.18, created on 2016-05-19 17:17:36
         compiled from /var/www/vhosts/excelsiorschool.com/httpdocs/formtools/themes/default/admin/settings/tab_accounts.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'upper', '/var/www/vhosts/excelsiorschool.com/httpdocs/formtools/themes/default/admin/settings/tab_accounts.tpl', 1, false),array('modifier', 'escape', '/var/www/vhosts/excelsiorschool.com/httpdocs/formtools/themes/default/admin/settings/tab_accounts.tpl', 20, false),array('modifier', 'explode', '/var/www/vhosts/excelsiorschool.com/httpdocs/formtools/themes/default/admin/settings/tab_accounts.tpl', 118, false),array('modifier', 'in_array', '/var/www/vhosts/excelsiorschool.com/httpdocs/formtools/themes/default/admin/settings/tab_accounts.tpl', 120, false),array('function', 'ft_include', '/var/www/vhosts/excelsiorschool.com/httpdocs/formtools/themes/default/admin/settings/tab_accounts.tpl', 3, false),array('function', 'themes_dropdown', '/var/www/vhosts/excelsiorschool.com/httpdocs/formtools/themes/default/admin/settings/tab_accounts.tpl', 30, false),array('function', 'menus_dropdown', '/var/www/vhosts/excelsiorschool.com/httpdocs/formtools/themes/default/admin/settings/tab_accounts.tpl', 35, false),array('function', 'pages_dropdown', '/var/www/vhosts/excelsiorschool.com/httpdocs/formtools/themes/default/admin/settings/tab_accounts.tpl', 40, false),array('function', 'languages_dropdown', '/var/www/vhosts/excelsiorschool.com/httpdocs/formtools/themes/default/admin/settings/tab_accounts.tpl', 51, false),array('function', 'timezone_offset_dropdown', '/var/www/vhosts/excelsiorschool.com/httpdocs/formtools/themes/default/admin/settings/tab_accounts.tpl', 59, false),array('function', 'template_hook', '/var/www/vhosts/excelsiorschool.com/httpdocs/formtools/themes/default/admin/settings/tab_accounts.tpl', 72, false),)), $this); ?>
...
" /></td>
      <td align="center"><input type="checkbox" name="clients_may_edit_page_titles" <?php if ($this->_tpl_vars['settings']['clients_may_edit_page_titles'] == 'yes'): ?>checked<?php endif; ?> /></td>
    </tr>
    <tr>
...
" /></td>
      <td align="center"><input type="checkbox" name="clients_may_edit_footer_text" <?php if ($this->_tpl_vars['settings']['clients_may_edit_footer_text'] == 'yes'): ?>checked<?php endif; ?> /></td>
    </tr>
    <tr>
      <td class="pad_left_small"><?php echo $this->_tpl_vars['LANG']['phrase_default_theme']; ?>
</td>
      <td><?php echo smarty_function_themes_dropdown(array('name_id' => 'default_theme','default' => $this->_tpl_vars['settings']['default_theme']), $this);?>
</td>
      <td align="center"><input type="checkbox" name="clients_may_edit_theme" <?php if ($this->_tpl_vars['settings']['clients_may_edit_theme'] == 'yes'): ?>checked<?php endif; ?> /></td>
    </tr>
    <tr>
...
" style="width: 98%" /></td>
      <td align="center"><input type="checkbox" name="clients_may_edit_logout_url" <?php if ($this->_tpl_vars['settings']['clients_may_edit_logout_url'] == 'yes'): ?>checked<?php endif; ?> /></td>
    </tr>
    <tr>
...
" onclick="window.location='index.php?page=accounts&refresh_lang_list'" />
      ...
      <td align="center"><input type="checkbox" name="clients_may_edit_ui_language" <?php if ($this->_tpl_vars['settings']['clients_may_edit_ui_language'] == 'yes'): ?>checked<?php endif; ?> /></td>
    </tr>
    <tr>
      ...
      <td align="center"><input type="checkbox" name="clients_may_edit_timezone_offset" <?php if ($this->_tpl_vars['settings']['clients_may_edit_timezone_offset'] == 'yes'): ?>checked<?php endif; ?> /></td>
    </tr>
    <tr>
...
" style="width: 30px" /> <?php echo $this->_tpl_vars['LANG']['word_minutes']; ?>
      ...
      <td align="center"><input type="checkbox" name="clients_may_edit_sessions_timeout" <?php if ($this->_tpl_vars['settings']['clients_may_edit_sessions_timeout'] == 'yes'): ?>checked<?php endif; ?> /></td>
    </tr>
    <tr>
...
" style="width: 80px" /> <span class="medium_grey"><?php echo $this->_tpl_vars['text_date_formatting_link']; ?>
      ...
      <td align="center"><input type="checkbox" name="clients_may_edit_date_format" <?php if ($this->_tpl_vars['settings']['clients_may_edit_date_format'] == 'yes'): ?>checked<?php endif; ?> /></td>
    </tr>
    ...
    <tr>
      ...
      <td align="center"><input type="checkbox" name="clients_may_edit_max_failed_login_attempts"
        <?php if ($this->_tpl_vars['settings']['clients_may_edit_max_failed_login_attempts'] == 'yes'): ?>checked<?php endif; ?> /></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        ...
        <div>
	        <input type="checkbox" name="required_password_chars[]" value="uppercase" id="rpc1" <?php if (((is_array($_tmp='uppercase')) ? $this->_run_mod_handler('in_array', true, $_tmp, $this->_tpl_vars['required_password_chars_arr']) : in_array($_tmp, $this->_tpl_vars['required_password_chars_arr']))): ?>checked<?php endif; ?> />
	          <label for="rpc1"><?php echo $this->_tpl_vars['LANG']['phrase_one_char_upper']; ?>
</label>
	      </div>
        <div>
	        <input type="checkbox" name="required_password_chars[]" value="number" id="rpc2" <?php if (((is_array($_tmp='number')) ? $this->_run_mod_handler('in_array', true, $_tmp, $this->_tpl_vars['required_password_chars_arr']) : in_array($_tmp, $this->_tpl_vars['required_password_chars_arr']))): ?>checked<?php endif; ?> />
	          <label for="rpc2"><?php echo $this->_tpl_vars['LANG']['phrase_one_char_number']; ?>
</label>
	      </div>
        <div>
	        <input type="checkbox" name="required_password_chars[]" value="special_char" id="rpc3" <?php if (((is_array($_tmp='special_char')) ? $this->_run_mod_handler('in_array', true, $_tmp, $this->_tpl_vars['required_password_chars_arr']) : in_array($_tmp, $this->_tpl_vars['required_password_chars_arr']))): ?>checked<?php endif; ?> />
    ...
    <p>
      <input type="submit" name="update_accounts" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['LANG']['word_update'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)); ?>
" />
    </p>

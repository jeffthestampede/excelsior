...
fclose($fh);
$display_text='Your system has been successfully upgraded to version 6.1. Please click the Login button to proceed to login with your existing login credentials.
';

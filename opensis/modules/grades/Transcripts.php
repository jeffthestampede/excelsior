...
if(!$_REQUEST['modfunc'])
{
	...
	if($_REQUEST['search_modfunc']=='list')
	{
		...
		echo '<input type="checkbox" name="show_photo" id="show_photo" /> Include Student Picture';
                                    echo '<br />';
                                    echo '<input type="checkbox" name="incl_mp_grades" id="" checked disabled /> Include Marking Period grades';
                                    echo '<br />';
                                    echo '<input type="radio" name="template" id="" value="two" checked /> Two Column Template';
                                    echo '<input type="radio" name="template" id="" value="single" /> Single Column Template';

...
if(!$_REQUEST['modfunc'])
{
	...
	echo "<TR ALIGN=LEFT><TD  class='label'><b>Telephone:<font color=red>*</font></b></td><td>".TextInput($schooldata['PHONE'],'values[PHONE]','','class=cell_floating size=24')."</TD></TR>";
	echo "<TR ALIGN=LEFT><TD class='label'><b>Principal:<font color=red>*</font></b></td><td>".TextInput($schooldata['PRINCIPAL'],'values[PRINCIPAL]','','class=cell_floating size=24')."</TD></TR>";
        echo "<TR ALIGN=LEFT><TD class='label'><b>Base Grading Scale:<font color=red>*</font></b></td><td>".TextInput($schooldata['REPORTING_GP_SCALE'],'values[REPORTING_GP_SCALE]','','class=cell_floating maxlength=10 size=24')."</TD></TR>";

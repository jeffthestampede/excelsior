...
include('../../RedirectModulesInc.php');
                             ...
                             {  
                              ...
                              else
                              {
                                  ...
                                  if($go_tot_seat=='y')
                                  {
                                      ...
                                      echo '<font style="color:red"><b>Cannot change room capacity as it has association.</b></font>';
    ...
    else if(isset($validate_srt_odr) && count($validate_srt_odr)!=0)
    {
        ...
        if($samedata!=$srt_odr)
            echo "<font color='red'><b>Unable to save data, because sort order already exists.</b></font>";
    }

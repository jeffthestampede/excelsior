...
$groupname=$group_details[1]['GROUP_NAME'];
 $desc = $group_details[1]['DESCRIPTION'];
    ...
    echo "<FORM name=Group id=Compose action=Modules.php?modname=messaging/Group.php&modfunc=member_insert&grp_id=" . strip_tags(trim($_REQUEST[grp_id])) . " method=POST >";

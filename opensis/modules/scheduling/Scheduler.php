                     ...
                     if($same_cp[1]['REC_EX']==0)
                     {
                         ...
                         foreach($student_cp_ids as $sd)
                         {
                             ...
                             foreach($get_det as $gi=>$gd)
                             {
                                 ...
                                 {
                                     if($gd['PERIOD_ID']==$gnd['PERIOD_ID'])
                                         $flag++;
                                     if(strtotime($gd['START_TIME'])==strtotime($gnd['START_TIME']))
                                         $flag++;
                                     if(strtotime($gd['END_TIME'])==strtotime($gnd['END_TIME']))
                                         $flag++;
                                     if(strtotime($gd['START_TIME'])>=strtotime($gnd['START_TIME']) && strtotime($gd['START_TIME'])<=strtotime($gnd['END_TIME']))
                                         $flag++;
                                     if(strtotime($gd['END_TIME'])>=strtotime($gnd['START_TIME']) && strtotime($gd['END_TIME'])<=strtotime($gnd['END_TIME']))
                                         $flag++;
                                 }
                             }
                         }
